...
#include "MT/MT_Tracking/cv/MT_CalibrationDataFile.h"
...
int main(int argc, char** argv)
{
    ...
    MT_CalibrationData d;
    MT_OpenCVCalibrationToCalibrationData(cameraMatrix, k, Rv, T, &d);
    ...
    MT_CalibrationDataFile outFile(argv[2], MT_CALIB_WRITE);
